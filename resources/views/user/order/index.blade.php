    ...
    <div class="container py-4">
        ...
        @if ($orders->isEmpty())
            <div class="text-center py-5">
                <img src="{{ asset('images/order/no_order.webp') }}" alt="No orders illustration" width="160" class="mb-4">
        ...
        @else
            @foreach ($orders as $order)
                <a href="{{ route('customer.order.show', $order['order_id']) }}" class="text-decoration-none text-dark">
